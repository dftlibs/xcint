...
extern void dsymm_(char *si, char *up, int *m, int *n, double *alpha,
                   const double *a, int *lda, const double *b, int *ldb,
                   double *beta, double *c, int *ldc);
};
#endif
                 ...
                 double *beta, double *c, int *ldc)
{
    ...
    cblas_dgemm(CblasRowMajor, cta, ctb, *m, *n, *k, *alpha, a, *lda, b, *ldb,
                *beta, c, *ldc);
#else
                 ...
                 double *beta, double *c, int *ldc)
{
    ...
    cblas_dsymm(CblasRowMajor, cs, cu, *n, *m, *alpha, a, *lda, b, *ldb, *beta,
                c, *ldc);
#else
