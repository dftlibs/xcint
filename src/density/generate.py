...
def main():
    ...
    write_parameters(os.path.join(script_directory, 'parameters.h'))
    write_offsets(os.path.join(script_directory, 'offsets.h'))
    for g in range(0, MAX_GEO_DIFF_ORDER+1):
        write_routine(g, os.path.join(script_directory, 'autogenerated_%i.cpp' % g))
    write_aocalls(os.path.join(script_directory, 'aocalls.h'))
    write_header(os.path.join(script_directory, 'autogenerated.h'))
