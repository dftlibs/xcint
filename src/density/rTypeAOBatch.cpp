...
void rTypeAOBatch::get_ao(const rTypeBasis &basis,
...
void rTypeAOBatch::get_ao_shell(const int        ishell,
...
void rTypeAOBatch::compress(const rTypeBasis       &basis,
                            const bool             use_gradient,
                                  int              &aoc_num,
                                  int              *(&aoc_index),
                                  double           *(&aoc),
...
void rTypeAOBatch::distribute_matrix_undiff(const int    mat_dim,
                                            const bool   use_gradient,
                                            const bool   use_tau,
...
void rTypeAOBatch::distribute_matrix(const int    mat_dim,
                                     const bool   use_gradient,
                                     const bool   use_tau,
                                     const double prefactors[],
                                     const double u[],
...
void rTypeAOBatch::get_density(const int    mat_dim,
                               const bool   use_gradient,
                               const bool   use_tau,
                               const double prefactors[],
                                     double density[],
...
void rTypeAOBatch::get_dens_geo_derv(const rTypeBasis       &basis,
                                     const int              mat_dim,
                                     const bool             use_gradient,
                                     const bool             use_tau,
                                     const std::vector<int> &coor,
...
void rTypeAOBatch::diff_wrt_center_tuple(const rTypeBasis       &basis,
                                         const int              mat_dim,
                                         const bool             use_gradient,
                                         const bool             use_tau,
                                         const double           f,
...
bool rTypeAOBatch::is_same_center(const int              c,
